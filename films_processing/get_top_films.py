from text_proccesing.unique_counter import count_words
...
def description_of_films(rating):
  # Створення списку фільмів з рейтингом, який більше або дорівнює заданому значенню
  el_films = [film for film in imdb_rank if float(film['rating']) >= rating]

  # Вибір випадкового фільму зі списку фільмів
  random_film = random.choice(el_films)

  # Повернення опису вибраного фільму
  return random_film['description']

print(description_of_films(8.2))

print(count_words(description_of_films(8.2)))